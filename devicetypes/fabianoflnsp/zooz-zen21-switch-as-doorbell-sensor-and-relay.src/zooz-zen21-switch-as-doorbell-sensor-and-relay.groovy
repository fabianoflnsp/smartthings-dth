/**
 *  Zooz Zen21 Switch as Doorbell Sensor and Relay
 *
 *  Based on the work of Don Caruana - Zooz Zen21 Switch v2
 *
 ...
 *  2018-12-11 - Added support for Contact Sensor on Traveler contact
 *
 ...
 */
metadata {
	definition (name: "Zooz Zen21 Switch as Doorbell Sensor and Relay", namespace: "fabianoflnsp", author: "Fabiano dos Santos", ocfDeviceType: "oic.d.switch", mnmn: "SmartThings", vid: "generic-switch") {
		capability "Actuator"
...
//zw:L type:1001 mfr:015D prod:0111 model:1E1C ver:20.15 zwv:4.05 lib:06 cc:5E,86,72,5A,73,85,59,25,27,20,70 role:05 ff:9D00 ui:9D00
	...
	fingerprint mfr:"015D", prod:"0111", model:"1E1C", deviceJoinName: "Zooz Zen21 Switch as Doorbell Sensor and Relay"
	fingerprint deviceId:"0x1001", inClusters: "0x5E,0x59,0x85,0x70,0x5A,0x72,0x73,0x27,0x25,0x86,0x20"
	fingerprint cc: "0x5E,0x59,0x85,0x70,0x5A,0x72,0x73,0x27,0x25,0x86,0x20", mfr:"015D", prod:"0111", model:"1E1C", deviceJoinName: "Zooz Zen21 Switch as Doorbell Sensor and Relay"
	}
	...
	preferences {
		...
		input "contactType", "enum", title: "Contact Sensor Type", description: "Normally open", required: false, options:["no": "Normally open", "nc": "Normally closed"], defaultValue: "no"
	}

    def closedColor = "#ffffff"
    def openColor = "#53a7c0"
	...
	tiles(scale: 2) {
		...
		standardTile("contact", "device.contact", inactiveLabel: false, height:2, width:2, canChangeIcon: false) {
            state "closed", label:'${name}', backgroundColor: closedColor, icon:"st.contact.contact.closed" 
            state "open", label:'${name}', backgroundColor: openColor, icon:"st.contact.contact.open" 
		}
		...
		main "switch"
		details(["switch","contact","indicator","refresh"])
	}
}
